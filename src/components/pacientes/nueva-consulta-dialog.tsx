  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const historiaData = {
        ...
        proximoControl: formData.proximoControl ? `${formData.proximoControl}T00:00:00` : null,
      ...
      toast({
        title: "Error",
        description: error.message || "No se pudo registrar la consulta. Intente nuevamente.",
        variant: "destructive",
      })
    } finally {
      setLoading(false)
